        ...
        return [
            Tool(
                ...
                description=(
                    ...
                    "to-save source code that compiles with `axintai compile`."
                ),
                inputSchema={
                    "type": "object",
                    "properties": {
            ...
            Tool(
                name="axint_compile",
                description=(
                    "Compile a Python intent definition into a native Swift App "
                    "Intent. Optionally emits Info.plist and entitlements fragments "
                    "alongside the Swift file. Pass the full Python source code."
                ),
                inputSchema={
                    "type": "object",
                    "properties": {
            ...
            Tool(
                ...
                description=(
                    "Compile a minimal JSON schema directly to Swift, bypassing Python DSL. "
                    "Supports intents, views, and widgets. Minimal JSON means ~20 tokens vs "
                    "hundreds for full Python code. Returns Swift code with token usage stats."
                ),
                inputSchema={
                    "type": "object",
                    "properties": {
