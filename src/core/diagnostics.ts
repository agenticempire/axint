...
export const DIAGNOSTIC_CODES: Record<string, DiagnosticInfo> = {
  ...
  AX861: {
    ...
    severity: "warning",
    message:
      "Xcode 27 @State macro initializer assignment conflicts with an initial value",
    category: "swiftui-state-macro",
    compilerContradictable: true,
  },
  AX862: {
    code: "AX862",
    severity: "warning",
    message: "Xcode 27 @State macro can disable the delegated synthesized initializer",
    category: "swiftui-state-macro",
    compilerContradictable: true,
  },
  AX863: {
    code: "AX863",
    severity: "warning",
    message: "Deprecated SwiftUI document protocol should migrate to the 27 SDK model",
    category: "swiftui-api-migration",
  },
  AX864: {
    code: "AX864",
    severity: "warning",
    message: "Document reader or writer should use @concurrent under the 27 SDK",
    category: "swift-concurrency",
    compilerContradictable: true,
  },
  AX865: {
    code: "AX865",
    severity: "warning",
    message: "SwiftUI toolbar minimization modifier uses the pre-27 spelling",
    category: "swiftui-api-migration",
    compilerContradictable: true,
  },
  AX866: {
    code: "AX866",
    severity: "info",
    message: "SwiftUI text field style is soft deprecated in the 27 SDK",
    category: "swiftui-api-migration",
  },
  AX867: {
    code: "AX867",
    severity: "warning",
    message: "On Demand Resources API is deprecated in favor of Background Assets",
    category: "swift-api-migration",
  },
  AX868: {
    code: "AX868",
    severity: "warning",
    message: "Private Cloud Compute model has no explicit sampling mode",
    category: "swift-foundation-models",
  },
  AX869: {
    code: "AX869",
    severity: "warning",
    message: "Selectable Text can conflict with a custom gesture in iOS 27",
    category: "swiftui-interaction",
    evidenceClass: "interaction",
  },
  AX870: {
    code: "AX870",
    severity: "warning",
    message: "TabView selection can point to a hidden tab in iOS 27",
    category: "swiftui-runtime",
