 ...
 * calls axint.scaffold and writes the result straight to disk.
 */
...
export function scaffoldIntent(input: ScaffoldInput): string {
  ...
  lines.push(` * ${desc}`);
  lines.push(` *`);
  lines.push(` * Generated by axint.scaffold. Edit freely, then run:`);
  lines.push(` *   npx @axint/compiler compile src/intents/${kebab(name)}.ts`);
  lines.push(` */`);
  lines.push(`import { defineIntent, param } from "@axint/compiler";`);
  lines.push(``);
